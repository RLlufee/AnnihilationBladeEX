package QWQ.QingYi.annihilationbladeex.event;
...
import QWQ.QingYi.annihilationbladeex.annihilation_blade.logic.WorldRiftChain;
...
public class ModEventHandler {
   ...
   public static void onItemTooltip(ItemTooltipEvent event) {
      ...
      if (isGodBlade(stack)) {
         ...
         if (!tooltip.isEmpty()) {
            ...
            tooltip.add(
               1,
               Component.translatable("item.annihilationbladeex.desc.line4").withStyle(new ChatFormatting[]{ChatFormatting.DARK_PURPLE, ChatFormatting.ITALIC})
            );
            tooltip.add(
               1,
               Component.translatable("item.annihilationbladeex.desc.line3").withStyle(new ChatFormatting[]{ChatFormatting.DARK_PURPLE, ChatFormatting.ITALIC})
            );
            tooltip.add(
               1,
               Component.translatable("item.annihilationbladeex.desc.line2").withStyle(new ChatFormatting[]{ChatFormatting.DARK_PURPLE, ChatFormatting.ITALIC})
            );
            tooltip.add(
               1,
               Component.translatable("item.annihilationbladeex.desc.line1").withStyle(new ChatFormatting[]{ChatFormatting.DARK_PURPLE, ChatFormatting.ITALIC})
            );
            tooltip.add(1, Component.literal(" "));
            tooltip.add(1, Component.translatable("item.annihilationbladeex.passive"));
         }
      }
   }
   ...
   private static MutableComponent buildRainbowDamageLine() {
      ...
      String rawText = Component.translatable("item.annihilationbladeex.infinite_damage").getString();
   ...
   public static void onGodBladeAttack(LivingIncomingDamageEvent event) {
