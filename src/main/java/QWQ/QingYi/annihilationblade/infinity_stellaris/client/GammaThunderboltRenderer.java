...
public class GammaThunderboltRenderer extends EntityRenderer<GammaThunderboltEntity> {
   ...
   private static void quad(
      ...
      consumer.vertex(matrix, x + (xPositive ? outer : -outer), (float)(segment * 16), z + (zPositive ? outer : -outer)).color(red, green, blue, alpha).endVertex();
      consumer.vertex(matrix, previousX + (xPositive ? inner : -inner), (float)((segment + 1) * 16), previousZ + (zPositive ? inner : -inner))
         .color(red, green, blue, alpha)
         .endVertex();
      consumer.vertex(matrix, previousX + (previousXPositive ? inner : -inner), (float)((segment + 1) * 16), previousZ + (previousZPositive ? inner : -inner))
         .color(red, green, blue, alpha)
         .endVertex();
      consumer.vertex(matrix, x + (previousXPositive ? outer : -outer), (float)(segment * 16), z + (previousZPositive ? outer : -outer))
         .color(red, green, blue, alpha)
         .endVertex();
   }
