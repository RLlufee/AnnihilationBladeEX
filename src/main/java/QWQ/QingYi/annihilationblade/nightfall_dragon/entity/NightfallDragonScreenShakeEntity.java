...
public class NightfallDragonScreenShakeEntity extends Entity {
   ...
   public static NightfallDragonScreenShakeEntity createInstance(PlayMessages.SpawnEntity packet, Level level) {
      return new NightfallDragonScreenShakeEntity(ModEntities.NIGHTFALL_SCREEN_SHAKE.get(), level);
   }
   ...
   protected void defineSynchedData() {
      ...
      this.entityData.define(MAGNITUDE, 0.08F);
      this.entityData.define(DURATION, 0);
      this.entityData.define(FADE_DURATION, 8);
   }
